  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Everything changed in your clinic, by whom and when. Only people whose role allows it see this.</p>
      </div>
      ...
      <Card className="p-4">
        <form className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4" action="/activity">
          ...
          <select name="patient" defaultValue={patient} aria-label="Patient" className="rounded-lg border border-slate-200 px-3 py-2 text-sm">
