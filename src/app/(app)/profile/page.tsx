...
export default async function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Card className="p-6">
        <h2 className="mb-1 text-base font-semibold text-slate-900">My roles</h2>
        <div className="mb-4 mt-2 flex flex-wrap gap-1.5">
          {viewer.roles.length > 0 ? (
            ...
            <span className="text-sm text-slate-500">You have no roles in this clinic.</span>
          )}
        </div>
        <h3 className="mb-2 text-sm font-semibold text-slate-700">What I can do</h3>
        <p className="mb-4 text-sm text-slate-500">Ask an admin if you need something that isn&apos;t here.</p>
