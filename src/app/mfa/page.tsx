      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-slate-900">
            {mfa === "needs_setup" ? t("Set up two-factor sign-in") : t("Two-factor sign-in")}
          </h1>
          <p className="mt-1 text-sm text-slate-500">
            {mfa === "needs_setup"
              ? t("Required for the platform area. You'll need an authenticator app such as Google Authenticator or Authy.")
